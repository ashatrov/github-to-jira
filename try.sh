...
echo "Start: Can NOT apply"
curl -H 'X-GitHub-Event: issues' --data '
{
  "action": "opened",
  "issue": {
    ...
    "id": 73464126,
    "number": 2,
    "title": "[#KEY-123][B2B-65] Spelling error in the README file",
    "user": {
    ...
    "labels": [
      {
        "id": 208045946,
        "url": "https://api.github.com/repos/baxterthehacker/public-repo/labels/comments",
        "name": "comments",
        "color": "fc2929",
        "default": true
      }
...
' http://localhost:8000/webhook.php\?secret\=qwerty123456qwerty123456qwerty123456
echo "End: Can NOT apply"


echo "Start: Can apply"
curl -H 'X-GitHub-Event: issues' --data '
{
  "action": "opened",
  "issue": {
